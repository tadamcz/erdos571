...
|---|---|---|---|---|---|
| `Erdos571/Resolutions/Erdos571_325usd_42h.lean` | **primary** (wired to `Solution.lean`) | ReAct agent, larger budget, 26 Aug 2026 (re-run) | $325 | 42 h | [transcript](https://viewer.hawk.hawkbench.com/permalink/sample/UGjEnixSG6RApwvDzjTtiv) |
